...
export const addTaskTestCase = function (taskId, data) {//给任务添加用例
...
export const getTaskTestCase = function (taskId) { //获取任务的用例
...
export const getTaskReports = function (taskId) { //获取任务的执行结果
...
export const stopIntervalTask = function (taskId) {//停止循环任务
